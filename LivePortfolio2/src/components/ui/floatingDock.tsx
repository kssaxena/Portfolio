...
export const FloatingDockMobile = ({ items, className }) => {
  ...
  return (
    <div
      className={cn(
        "fixed block lg:hidden md:hidden right-0 w-full flex justify-start items-start px-5 py-4 z-50 text-white",
        className,
      )}
    >
      <AnimatePresence>
...
const FloatingDockDesktop = ({ items, className }) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        " w-fit  md:h-16 h-fit items-end gap-4 rounded-2xl bg-gray-50 px-4 pb-3 md:flex dark:bg-black/10 grid grid-cols-3",
        className,
      )}
    >
